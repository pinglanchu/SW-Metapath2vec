The processing of ACM and DBLP data mainly references the [HAN](https://github.com/Jhy1993/HAN), while the heterogeneous complex network for Last.FM was constructed using DGL. 
